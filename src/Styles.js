...
export function removeClass(elem, elemClass) {return elem.classList.remove(elemClass)}

export function toggleClass(elem, elemClass) {return elem.classList.toggle(elemClass)}
